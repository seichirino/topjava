...
public class MealTestData {
    ...
    public static void assertMatch(Iterable<Meal> actual, Meal... expected) {
        assertThat(actual).usingElementComparatorIgnoringFields("user").containsExactlyInAnyOrder(expected);
    }

    public static void assertMatch(Iterable<Meal> actual, List<Meal> expected) {
        assertThat(actual).usingElementComparatorIgnoringFields("user").containsExactlyInAnyOrderElementsOf(expected);
    }
